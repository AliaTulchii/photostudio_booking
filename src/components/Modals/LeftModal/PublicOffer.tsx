        ...
        <ul className='modal__list'>
              ...
              <h2 className='modal__subtitle subtitle'>Загальні положення</h2>
                    <ul className='modal__sublist'>              
                          ...
                          "Фотостудія" - ______________ (назва фотостудії), зареєстрована за адресою: ______________,
                          представлена ______________ (ПІБ власника) в особі ______________ (посада), що діє на
                          підставі ______________ (статуту, установчого документа).
                          </p>
                      </li> 
                      <li className='modal__item'>
                          <p className='modal__text'>
              ...
              <h2 className='modal__subtitle subtitle'>Предмет договору</h2>
                  ...
                  <li className='modal__subitem'>
                      ...
                      відповідно до тарифів, умов та обмежень, встановлених фотостудією.
                          </p>
                      </li> 
                      <li className='modal__item'>
                          <p className='modal__text'>
              ...
              <h2 className='modal__subtitle subtitle'>Вартість послуг та оплата</h2>
                  ...
                  <li className='modal__subitem'>
                          <p className='modal__text'>
                          Вартість фотографічних послуг визначається відповідно до тарифів,
                      що діють на момент укладення договору.
                          </p>
                      </li> 
                      <li className='modal__item'>
                          <p className='modal__text'>
