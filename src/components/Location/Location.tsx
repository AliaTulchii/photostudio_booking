...
import { AnimatePresence, motion } from 'framer-motion'; // Імпортуємо framer-motion
  ...
  return (
      <div className='location'>
        ...
        <button onClick={onShowClick} className='location__btn title'>
          Місцезнаходження {show ? <SlArrowUp className='location__arrow location__arrow--down' /> : <SlArrowDown className='location__arrow location__arrow--down' />}
        </button>
      <AnimatePresence>      
      {show && (
        <motion.div
        ...
        >
          <iframe
            ...
            width="320"
            height="250"
            style={{ border: 'solid 1px #C2B5A4', borderRadius: '8px' }}
            loading="lazy"
